...
# Xeon 6973P-C supports AVX512VL.  Enable it only for raw X67 so j==2/510
# becomes direct k-mask compares instead of AVX2 compare + movemask.
old_attr='OVEC __attribute__((noinline,hot,aligned(64))) static void octant_vector_v8_rawx67('
new_attr='__attribute__((target("avx512f,avx512dq,avx512vl,avx2,fma"),noinline,hot,aligned(64))) static void octant_vector_v8_rawx67('
if s.count(old_attr)!=1:
    raise SystemExit(f'raw X67 attr count={s.count(old_attr)}')
