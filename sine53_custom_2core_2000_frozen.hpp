...
class Sine53CustomPermanent2Core2000Frozen {
public:
    using fn_t = void (*)(double *, const double *, size_t);

    explicit Sine53CustomPermanent2Core2000Frozen(fn_t fn)
    ...
    ~Sine53CustomPermanent2Core2000Frozen() {
        stop_.store(true, std::memory_order_relaxed);
        generation_.fetch_add(1, std::memory_order_release);
        if (helper_.joinable()) helper_.join();
    }

    Sine53CustomPermanent2Core2000Frozen(const Sine53CustomPermanent2Core2000Frozen&) = delete;
    Sine53CustomPermanent2Core2000Frozen& operator=(const Sine53CustomPermanent2Core2000Frozen&) = delete;
