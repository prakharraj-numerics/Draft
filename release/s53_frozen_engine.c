...
/* These entrypoints must remain link-visible between the engine objects and
   the tiny public API object. The final linker version script localizes every
   symbol except the three public s53_* API names, so they do not survive as
   exported symbols in the release ELF. */
